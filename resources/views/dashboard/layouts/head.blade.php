<head>
    ...
    <meta name="description" content="Register with FTM here to open account and trade on financial markets">
    <meta name="csrf-param" content="_csrf">
    <title>FTM broker registration form</title>
    <meta name="google-site-verification" content="TilHeoMYPXh8Kwk-cYJjgQncPc9cIJ5fKh_e7M7-Ugc" />
    <meta property="og:title" content="FTM broker registration form">
    <meta property="og:description" content="Register with FTM here to open account and trade on financial markets">
    <meta property="og:url" content="registration.html">
    <meta property="og:image" content="{{ asset('images/new-site/logo3.png') }}">
    <meta property="og:image:secure_url" content=".{{ asset('images/new-site/logo3.png') }}">
