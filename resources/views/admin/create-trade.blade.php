                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-10">
                                                            <form class="form-horizontal" action="{{ route('admin.create_order_store') }}" method="POST">
                                                                @csrf
                                                                @if ($errors->any())
                                                                ...
                                                                <div class="form-row mb-4">
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <input type="text" name="pair" autocomplete="on" class="form-control" id="inputPassword4" placeholder="Market Pair">
                                                                    </div>
                                                                    <div class="form-group col-md-6">
