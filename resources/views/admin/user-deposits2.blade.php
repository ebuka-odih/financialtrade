                                ...
                                <div class="col-xl-9 col-md-8">
                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        @foreach($deposits->deposits as $deposit)
                                            <tr>
                                                <td><strong>{{ $deposit->user->name }}</strong></td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('admin.deposit_details', $deposit->id) }}" class="btn btn-secondary btn-sm">View</a>
                                                        @if($deposit->status == 'pending')
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                                <a class="dropdown-item" href="{{ route('admin.approve_deposit', $deposit) }}">Approve</a>
                                                            </div>
                                                        @else
                                                        @endif
                                                    </div>
