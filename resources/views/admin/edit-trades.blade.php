            ...
            <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                ...
                <div class="work-experience layout-spacing ">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        @endif
                        <form action="{{ route('admin.update_trade', $trade->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-row mb-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" value="{{ old('price', optional($trade)->price) }}" step="any" name="price" class="form-control" id="inputPassword4" placeholder="Price">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">Pair</label>
                                    <input type="text" name="pair" value="{{ old('pair', optional($trade)->pair) }}" step="any" class="form-control" id="inputPassword4" placeholder="Market Pair">
                                </div>
                            </div>
                            <div class="form-row mb-4">
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">Opening Price</label>
                                    <input type="number" value="{{ old('opening_price', optional($trade)->opening_price) }}" step="any" name="opening_price" class="form-control" id="inputPassword4" placeholder="Opening Price">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">Closing Price</label>
                                    <input type="number" step="any" value="{{ old('closing_price', optional($trade)->closing_price) }}" name="closing_price" class="form-control" id="inputPassword4" placeholder="Closing Price">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">Buy At</label>
                                    <input type="number" step="any" value="{{ old('buy_at', optional($trade)->buy_at) }}" name="buy_at" class="form-control" id="inputPassword4" placeholder="Buy At">
                                </div>
                            </div>
