                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li><a href="{{ route('admin.all_withdrawal') }}">Withdrawals</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li><a href="{{ route('admin.investment-plans.create') }}">Add Package</a></li>
                            <li><a href="{{ route('admin.investment-plans.index') }}">All Packages</a></li>
                        </ul>
                    </li>
